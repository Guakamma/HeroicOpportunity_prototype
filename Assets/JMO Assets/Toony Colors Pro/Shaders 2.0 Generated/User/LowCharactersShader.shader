...
Shader "Toony Colors Pro 2/User/LowCharactersShader"
{
	Properties
	{
	...
	SubShader
	{
		...
		#pragma surface surf ToonyColorsCustom noforwardadd noshadow nofog nolightmap vertex:vert exclude_path:deferred exclude_path:prepass
		#pragma target 2.0
