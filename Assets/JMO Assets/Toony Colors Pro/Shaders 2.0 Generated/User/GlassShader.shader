...
Shader "Toony Colors Pro 2/User/GlassShader"
{
	Properties
	{
	...
	SubShader
	{
		...
		#pragma surface surf ToonyColorsCustom noforwardadd noshadow nolightmap vertex:vert keepalpha exclude_path:deferred exclude_path:prepass
		#pragma target 2.5
